...
type TradeRequest struct {
	...
	Volume           []byte             `protobuf:"bytes,4,opt,name=volume,proto3" json:"volume,omitempty"`                                                                                // Requested order volume in lots. Note that the real volume of a deal will depend on the order execution type.
	Price            []byte             `protobuf:"bytes,5,opt,name=price,proto3" json:"price,omitempty"`                                                                                  // Price, reaching which the order must be executed. Market orders of symbols, whose execution type is "Market Execution", of OrderAction.Deal type, do not require specification of price.
	StopLimit        []byte             `protobuf:"bytes,6,opt,name=stop_limit,json=stopLimit,proto3" json:"stop_limit,omitempty"`                                                         // The price value, at which the Limit pending order will be placed, when price reaches the price value (this condition is obligatory). Until then the pending order is not placed.
	StopLoss         []byte             `protobuf:"bytes,7,opt,name=stop_loss,json=stopLoss,proto3" json:"stop_loss,omitempty"`                                                            // Stop Loss price in case of the unfavorable price movement
	TakeProfit       []byte             `protobuf:"bytes,8,opt,name=take_profit,json=takeProfit,proto3" json:"take_profit,omitempty"`                                                      // Take Profit price in the case of the favorable price movement
	Deviation        []byte             `protobuf:"bytes,9,opt,name=deviation,proto3" json:"deviation,omitempty"`                                                                          // The maximal price deviation
...
func (x *TradeRequest) GetVolume() []byte {
	if x != nil {
		return x.Volume
	}
	return nil
...
func (x *TradeRequest) GetPrice() []byte {
	if x != nil {
		return x.Price
	}
	return nil
...
func (x *TradeRequest) GetStopLimit() []byte {
	if x != nil {
		return x.StopLimit
	}
	return nil
...
func (x *TradeRequest) GetStopLoss() []byte {
	if x != nil {
		return x.StopLoss
	}
	return nil
...
func (x *TradeRequest) GetTakeProfit() []byte {
	if x != nil {
		return x.TakeProfit
	}
	return nil
...
func (x *TradeRequest) GetDeviation() []byte {
	if x != nil {
		return x.Deviation
	}
	return nil
...
var file_protos_edge_data_trade_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x82, 0x05, 0x0a, 0x0c, 0x54,
	0x72, 0x61, 0x64, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x35, 0x0a, 0x06, 0x61,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x70, 0x72,
	...
	0x6f, 0x6e, 0x12, 0x21, 0x0a, 0x0c, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x74, 0x69, 0x63, 0x6b,
	0x65, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x54,
	...
	,
	...
	,
...
var file_protos_edge_data_trade_proto_goTypes = []interface{}{
	...
	(*gopb.UnixDuration)(nil), // 5: protos.common.UnixDuration
}
var file_protos_edge_data_trade_proto_depIdxs = []int32{
	...
	1, // 1: protos.edge.data.TradeRequest.type:type_name -> protos.edge.data.OrderType
	2, // 2: protos.edge.data.TradeRequest.fill_type:type_name -> protos.edge.data.FillPolicy
	3, // 3: protos.edge.data.TradeRequest.expiration_type:type_name -> protos.edge.data.ExpirationPolicy
	5, // 4: protos.edge.data.TradeRequest.expiration:type_name -> protos.common.UnixDuration

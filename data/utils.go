...
// Value converts a data.AllowedTrades value to an SQL driver value
...
// UnmarshalDynamoDBAttributeValue attempts to convert a DynamoDB AttributeVAlue to a data.AllowedTrades
...
func (enum *AllowedTrades) UnmarshalDynamoDBAttributeValue(value types.AttributeValue) error {
	...
	case *types.AttributeValueMemberS:
		return utils.UnmarshalString(casted.Value, AllowedTrades_value, AllowedTradesAlternates, enum)
	default:
		return fmt.Errorf("Attribute value of %T could not be converted to a data.AllowedTrades", value)
	}
}

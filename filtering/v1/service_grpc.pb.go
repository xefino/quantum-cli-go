...
const (
	FilterService_GetName_FullMethodName      = "/protos.edge.filtering.v1.FilterService/GetName"
	FilterService_ShouldFilter_FullMethodName = "/protos.edge.filtering.v1.FilterService/ShouldFilter"
)
...
func (c *filterServiceClient) GetName(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*data.NameResult, error) {
	...
	err := c.cc.Invoke(ctx, FilterService_GetName_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *filterServiceClient) ShouldFilter(ctx context.Context, in *data.StrategyContext, opts ...grpc.CallOption) (*FilterResult, error) {
	...
	err := c.cc.Invoke(ctx, FilterService_ShouldFilter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FilterService_GetName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FilterService_GetName_FullMethodName,
	}
...
func _FilterService_ShouldFilter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FilterService_ShouldFilter_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
